...
import com.groupeisi.m2gl.security.*;
import com.groupeisi.m2gl.security.SecurityUtils;
import com.groupeisi.m2gl.security.oauth2.AudienceValidator;
import java.util.*;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz ->
                // prettier-ignore
                authz
                    .requestMatchers(antMatcher("/ws/**")).permitAll() // WebSocket STOMP endpoint
                    .requestMatchers(antMatcher("/ws-simple/**")).permitAll() // WebSocket simple endpoint (Postman)
