...
import static com.groupeisi.m2gl.domain.BookAsserts.*;
import static com.groupeisi.m2gl.web.rest.TestUtil.createUpdateProxyForBean;
...
class BookResourceIT {
    ...
    public static Book createEntity() {
        return new Book().title(DEFAULT_TITLE).prix(DEFAULT_PRIX).author(DEFAULT_AUTHOR).date_pub(DEFAULT_DATE_PUB);
    }
    ...
    public static Book createUpdatedEntity() {
        return new Book().title(UPDATED_TITLE).prix(UPDATED_PRIX).author(UPDATED_AUTHOR).date_pub(UPDATED_DATE_PUB);
    }
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].date_pub").value(hasItem(DEFAULT_DATE_PUB.toString())));
    }
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.date_pub").value(DEFAULT_DATE_PUB.toString()));
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).prix(UPDATED_PRIX).author(UPDATED_AUTHOR).date_pub(UPDATED_DATE_PUB);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).prix(UPDATED_PRIX).author(UPDATED_AUTHOR).date_pub(UPDATED_DATE_PUB);
